...
export default function ControlScreen() {
  ...
  const [cleaningMode, setCleaningMode] = useState<"auto" | "spot" | "edge">(
    "auto",
  );
  const [fanSpeed, setFanSpeed] = useState<"quiet" | "standard" | "turbo">(
    "standard",
  );
  ...
  const simulateAction = useCallback(
    async (
      ...
      try {
        ...
        const isConnected = robotService.isConnected();
  ...
  const handleStartCleaning = useCallback(() => {
    ...
    simulateAction(
      ...
      async () => {
        await robotService.sendCommand("START_CLEANING");
      }, // WiFi: POST /command | BLE: GATT write
    );
  }, [
    busy,
    isRunning,
  ...
  const handleStopCleaning = useCallback(() => {
    ...
    simulateAction(
      ...
      async () => {
        await robotService.sendCommand("STOP_CLEANING");
      }, // WiFi: POST /command | BLE: GATT write
    );
  ...
  const handleReturnToDock = useCallback(() => {
    ...
    simulateAction(
      ...
      async () => {
        await robotService.sendCommand("RETURN_CHARGE");
      }, // WiFi: POST /command | BLE: GATT write
    );
  ...
  const handleManualMove = useCallback(
    (direction: "forward" | "backward" | "left" | "right" | "stop") => {
      ...
      // WiFi: POST /command | BLE: GATT write to command characteristic
      // === C++ BRIDGE: replace with RobotBridge.move(direction) ===
      const moveMap = {
        forward: "FORWARD",
        backward: "BACKWARD",
        left: "LEFT",
  ...
  const handleRotate = useCallback(
    (direction: "left" | "right") => {
      ...
      // Send command to robot if connected (best-effort, non-blocking)
      // WiFi: POST /command | BLE: GATT write to command characteristic
      // === C++ BRIDGE: replace with RobotBridge.rotate(direction) ===
      robotService
        .sendCommand(direction === "left" ? "LEFT" : "RIGHT")
        .catch((err: any) =>
  ...
  const handleManualModeToggle = useCallback(() => {
    ...
    console.log(
      "[ControlScreen] Manual mode:",
      newManualMode ? "enabled" : "disabled",
    );
          ...
          >
            ...
            <View style={styles.primaryControls}>
              ...
              >
                ...
                <AppText
                  style={[styles.primaryButtonText, { color: textPrimary }]}
                >
              ...
              {(["auto", "spot", "edge"] as const).map((mode) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.modeButton,
                    {
                      ...
                      borderColor:
                        cleaningMode === mode ? colors.primary : cardBorder,
                    },
                    cleaningMode === mode && {
                ...
                >
                  <Ionicons
                    ...
                    size={24}
                    color={
                      cleaningMode === mode ? colors.primary : textSecondary
                    }
                  />
                  <AppText
                    style={[
                      ...
                      {
                        color:
                          cleaningMode === mode ? colors.primary : textPrimary,
                      },
                    ]}
                  >
                    {mode === "auto"
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.speedButton,
                    {
                      backgroundColor: cardBg,
                      borderColor:
                        fanSpeed === speed ? colors.primary : cardBorder,
                    },
                    fanSpeed === speed && {
                      backgroundColor: `${colors.primary}15`,
                    },
                ...
                >
                  ...
                  <AppText
                    style={[
                      ...
                      {
                        color:
                          fanSpeed === speed ? colors.primary : textPrimary,
                      },
                    ]}
                  >
                  ...
                  <AppText
                    style={[styles.speedSubtext, { color: textSecondary }]}
                  >
                    {speed === "quiet"
                      ? "Low noise"
                      : speed === "standard"
          ...
          >
            ...
            {manualMode ? (
              <View style={styles.joystickContainer}>
                ...
                <View style={styles.rotationControls}>
                  ...
                  >
                    ...
                    />
                    <AppText
                      style={[styles.rotationText, { color: textPrimary }]}
                    >
                      Left
                    </AppText>
                  </TouchableOpacity>
                ...
                >
                  ...
                  />
                  <AppText
                    style={[styles.manualInfoText, { color: textPrimary }]}
                  >
                    Use joystick to manually navigate. Robot adapts to obstacles
                    via sensors & cameras.
                  </AppText>
                </View>
              </View>
              ...
              <View style={styles.comingSoonContainer}>
                ...
                <AppText
                  style={[styles.comingSoonText, { color: textSecondary }]}
                >
                  Enable manual mode
                </AppText>
                <AppText
                  style={[styles.comingSoonSubtext, { color: textSecondary }]}
                >
          ...
          <View style={styles.navSection}>
            ...
            <View style={styles.navButtons}>
              ...
              >
                ...
                <AppText style={[styles.navButtonText, { color: textPrimary }]}>
                  Dashboard
                </AppText>
              </TouchableOpacity>
