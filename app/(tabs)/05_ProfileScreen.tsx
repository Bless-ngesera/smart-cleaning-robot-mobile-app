    ...
    <TouchableOpacity
      ...
      style={[
        abS.btn,
        {
          backgroundColor: bg,
          borderColor,
          borderWidth: isOutline || isDisabled ? 1.5 : 0,
        },
        style,
      ]}
    >
      ...
      <AppText style={[abS.label, { color: textColor }]}>{title}</AppText>
    </TouchableOpacity>
  );
}
        ...
        <View style={[styles.wrapper, isLargeScreen && styles.largeWrapper]}>
          ...
          >
            ...
            >
              ...
              >
                <View
                  style={[styles.switchThumb, darkMode && styles.switchThumbOn]}
                />
              </View>
            </TouchableOpacity>
          </View>
            ...
            {MENU_ITEMS.map((item, index) => (
              ...
              >
                ...
                <View style={styles.menuText}>
                  ...
                  <AppText
                    style={[styles.menuSubtitle, { color: textSecondary }]}
                  >
                    {item.subtitle}
                  </AppText>
                </View>
