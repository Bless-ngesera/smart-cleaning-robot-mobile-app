    ...
    >
      ...
      >
        <View style={[styles.wrapper, isLargeScreen && styles.largeWrapper]}>
            ...
            <View style={styles.statsContainer}>
              ...
              >
                <Ionicons
                  ...
                  color={successColor}
                />
                <AppText style={[styles.statValue, { color: successColor }]}>
                  {stats.completed}
                </AppText>
                <AppText style={[styles.statLabel, { color: textSecondary }]}>
                  Completed
              ...
              >
                ...
                <AppText style={[styles.statValue, { color: errorColor }]}>
                  {stats.failed}
                </AppText>
                <AppText style={[styles.statLabel, { color: textSecondary }]}>
                  Failed
          ...
          {/* Total Stats Row */}
          {history.length > 0 &&
            (stats.totalArea > 0 || stats.totalDuration > 0) && (
              <View
                style={[
              ...
              >
                <View style={styles.totalStatItem}>
                  ...
                  <AppText
                    style={[styles.totalStatValue, { color: textPrimary }]}
                  >
                    {stats.totalArea.toFixed(1)} m²
                  </AppText>
                  <AppText
                    style={[styles.totalStatLabel, { color: textSecondary }]}
                  >
                    Total Area
                  </AppText>
                </View>
          ...
          {error ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <AppText style={[styles.emptyTitle, { color: textPrimary }]}>
                No Cleaning Sessions
              </AppText>
              <AppText style={[styles.emptySubtext, { color: textSecondary }]}>
                Your cleaning history will appear here after the first cleaning
                session
              </AppText>
            </View>
          ) : (
