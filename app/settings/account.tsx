...
export default function AccountSettings() {
  ...
  const updatePassword = async () => {
    ...
    try {
      ...
      showToast(
        "Password updated successfully! Please use your new password next login.",
        "success",
      );
      ...
      >
        <View style={[styles.wrapper, isLargeScreen && styles.largeWrapper]}>
          ...
          >
            ...
            <View style={styles.field}>
              ...
              <View style={styles.inputWrapper}>
                ...
                >
                  <Ionicons
                    name={show.new ? "eye-off-outline" : "eye-outline"}
                    size={20}
                    color={textSecondary}
                  />
                </TouchableOpacity>
            ...
            {showPasswordWarning && !allRequirementsMet && (
              ...
              >
                ...
                <View style={styles.warningFooter}>
                  ...
                  />
                  <AppText
                    style={[styles.warningTimeout, { color: textSecondary }]}
                  >
            ...
            {confirmPassword.length > 0 && (
              <View style={styles.matchIndicator}>
                <Ionicons
                  ...
                  size={16}
                  color={
                    newPassword === confirmPassword ? successColor : errorColor
                  }
                />
                <AppText
                  style={[
          ...
          <AnimatedCard
            ...
            style={[
              styles.sectionCard,
              { backgroundColor: cardBg, borderColor: errorColor },
            ]}
          >
            <View style={styles.sectionHeader}>
            ...
            <View style={styles.field}>
              ...
              <View style={styles.inputWrapper}>
                ...
                />
                <TouchableOpacity
                  onPress={() => setShow({ ...show, delete: !show.delete })}
                  style={styles.eye}
                >
                  <Ionicons
                    name={show.delete ? "eye-off-outline" : "eye-outline"}
                    size={20}
                    color={textSecondary}
                  />
                </TouchableOpacity>
